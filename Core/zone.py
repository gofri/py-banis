...
class Zone(object):
    def __init__(self, name='', sub_zones=None, item_list=None):
        self.name = name
...
class ZonesWizard(object):
    ...
    @classmethod
    def get_multifloor(cls, first_floor=0, count_floors=1, rooms_per_floor=1, leap=1):
        return [cls.get_floor(floor * count_floors + 1, rooms_per_floor, leap) for floor in \
